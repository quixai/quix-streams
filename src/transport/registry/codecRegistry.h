...
namespace Quix { namespace Transport {
    ...
    class CodecRegistry{
        ...
        private:
             ...
             */
            std::map<ModelKey, std::vector<const AbstractCodec*>> codecs;
        ...
        public:
             ...
             * @params codec codec
             */
            void registerCodec(const ModelKey& modelKey, const AbstractCodec*);
             ...
             */
            std::vector<const AbstractCodec*>& retrieveCodecs(const ModelKey& modelKey);
             ...
             */
            const AbstractCodec* retrieveCodec(const ModelKey& modelKey, const std::string& codecKey);
             ...
             * @returns nullptr if no codec found, otherwise matching codec implementation
             */
            const AbstractCodec* retrieveFirstCodec(const ModelKey& modelKey);
